...
if sys eq 0 then filename=file_search('.\sav\'+data_namet+'\it_cor_data'+nm_ind+'\cor_data_it_'+'*.sav',count=count) & $
  image_sav='.\imagetest\'+data_namet+'\it_dirty_img'+nm_ind+'\' & data_sav='.\sav\'+data_namet+'\it_img_beam'+nm_ind+'\'
if sys eq 1 then filename=file_search('./sav/'+data_namet+'/it_cor_data'+nm_ind+'/cor_data_it_'+'*.sav',count=count) & $
  image_sav='./imagetest/'+data_namet+'/it_dirty_img'+nm_ind+'/' & data_sav='./sav/'+data_namet+'/it_img_beam'+nm_ind+'/'

  image_sav='./imagetest/'+data_namet+'/it_dirty_img'+nm_ind+'_test/' 
  data_sav='./sav/'+data_namet+'/it_img_beam'+nm_ind+'_test/'
...
if sys eq 1 then filename_kp=file_search('./sav/'+data_namet+'/keep_table17_test.sav');;'+nm_ind+'
...
;-------------------------begins-------------------------
for ii=9,9 do begin ;count-1 ; for which file;+20-1
;  ;;for prep data
